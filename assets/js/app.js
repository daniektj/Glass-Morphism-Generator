...
document.querySelector(".generator_button").addEventListener("click", () => {
  document.querySelector(
    ".code_text"
  ).textContent = `<!-- This was made with GlassGenerator.netlify.app -->
...
/* --- BOTONES DE COPY--- */
function copiarAlPortapapeles(code_text1) {
  var html = document.createElement("input")
  html.setAttribute("value", document.getElementById(code_text1).innerHTML)
  document.body.appendChild(html)
  html.select()
  document.execCommand("copy")
  document.body.removeChild(html)
}
function copiarAlPortapapeles(code_text2) {
  var css = document.createElement("input")
  css.setAttribute("value", document.getElementById(code_text2).innerHTML)
